                                ...
                                <?php if(isset($nama)) :?>
                                    <div class="card shadow mb-4">
                                        ...
                                        <!-- <div class="card-body text-gray-900"> -->
                                            ...
                                            <p><b>Masih belum puas dengan skor TOEFL yang Anda dapatkan hari ini? Yuk Belajar TOEFL Online di</b> <a href="https://access-es.id/" target="_blank"><b>access-es.id</b></a></p>
                                            <p><b>Bahasa Inggris jadi mudah hanya di</b> <a href="https://access-es.id/" target="_blank"><b>access-es.id</b></a></p>
                                        </div>
                                    </div>
                                <?php else :?>
                                    <div class="card shadow mb-4">
